package company_2.start;
import company_2.action.StudentAction;
import company_2.model.Student;
...
public class MainClass {
    ...
    public static void main(String[] args) {
        String DbOperation = "EXIT(0), ADD(1), UPDATE(2), DELETE(3), FETCHBYID(4), FETCHBYEMAIL(5), FETCHBYMOBNO(6), SEARCHBYNAME(7),"
        ...
        do {
            ...
            System.out.println("Выберите одну из предложенных операций (1-12):");
